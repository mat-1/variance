...
const mathOptions = {
  replace: (node: parser.DOMNode) => {
    if (!('attribs' in node)) return null;
...
// https://github.com/mathiasbynens/emoji-test-regex-pattern/blob/main/dist/latest/javascript.txt
const EMOJI_REGEX =
...
export function twemojify(
  ...
  return parse(content, maths ? mathOptions : undefined);
}
